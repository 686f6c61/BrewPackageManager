...
nonisolated enum BrewPackagesArgumentsBuilder {
    ...
    /// Builds arguments for listing pinned formulae.
    ///
    /// - Parameter debugMode: Whether to include debug output.
    /// - Returns: Argument array for `brew list --pinned`.
    static func listPinnedArguments(debugMode: Bool) -> [String] {
        var arguments = ["list", "--pinned"]
        if debugMode {
            arguments.append("--debug")
        }
        return arguments
    ...
    static func infoArguments(packageName: String, type: PackageType?, debugMode: Bool) -> [String] {
    ...
    ///   - debugMode: Whether to include debug output.
    /// - Returns: Argument array for `brew upgrade [--formula|--cask] <package>`.
    static func upgradePackageArguments(packageName: String, type: PackageType, debugMode: Bool) -> [String] {
    ...
    ///   - type: The package type (formula or cask).
    ///   - debugMode: Whether to include debug output.
    /// - Returns: Argument array for `brew uninstall [--formula|--cask] <package>`.
    static func uninstallPackageArguments(packageName: String, type: PackageType, debugMode: Bool) -> [String] {
